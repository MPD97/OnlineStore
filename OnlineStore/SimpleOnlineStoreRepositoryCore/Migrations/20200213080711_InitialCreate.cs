        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Carts_AspNetRoles_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductMainId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(nullable: true),
                    Description = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductsMain", x => x.ProductMainId);
                    table.ForeignKey(
                        name: "FK_ProductsMain_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductVariantId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(nullable: true),
                    VariantValue = table.Column<string>(nullable: true),
                    Description = table.Column<string>(nullable: true),
                    ProductMainId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductsVariant", x => x.ProductVariantId);
                    table.ForeignKey(
                        name: "FK_ProductsVariant_ProductsMain_ProductMainId",
                        column: x => x.ProductMainId,
                        principalTable: "ProductsMain",
                        principalColumn: "ProductMainId",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Products_ProductsVariant_ProductVariantId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Images_ProductsMain_ProductMainId",
                        column: x => x.ProductMainId,
                        principalTable: "ProductsMain",
                        principalColumn: "ProductMainId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductsMain_CategoryId",
                table: "ProductsMain",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductsVariant_ProductMainId",
